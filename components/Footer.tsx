      ...
      <footer className="bg-primary-dark text-white pt-24 pb-12 border-t border-white/5 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
            <div className="space-y-8">
              <Link to="/" className="flex items-center gap-3">
                <div className="bg-white p-2 rounded-xl w-12 h-12 flex items-center justify-center shadow-2xl">
                ...
                <div className="flex flex-col">
                  <span className="text-xl font-black tracking-tighter">SQ Consulting</span>
                  <span className="font-script text-secondary text-lg leading-none">Delivering Values...</span>
                </div>
              </Link>
              <p className="text-purple-100/60 text-sm leading-relaxed max-w-xs font-medium italic">
                Strategic advisory engineered for the unique pressures of the Nigerian market. From data to fiscal resilience.
              </p>
            </div>

            <div>
              <h4 className="text-secondary font-black mb-8 tracking-[0.3em] uppercase text-[10px]">Solutions</h4>
              <ul className="space-y-4 text-purple-100/50 text-sm font-bold uppercase tracking-widest text-[11px]">
            ...
            <div>
              <h4 className="text-secondary font-black mb-8 tracking-[0.3em] uppercase text-[10px]">Corporate</h4>
              <ul className="space-y-4 text-purple-100/50 text-sm font-bold uppercase tracking-widest text-[11px]">
                <li><Link to="/insights" className="hover:text-white transition">Latest Insights</Link></li>
            ...
            <div className="space-y-8">
              <h4 className="text-secondary font-black tracking-[0.3em] uppercase text-[10px]">Connect</h4>
              <div className="space-y-4 text-sm text-purple-100/60 font-medium">
                <p className="flex items-center gap-3"><span className="material-icons text-secondary text-lg">location_on</span> Lagos, Nigeria</p>
                <p className="flex items-center gap-3"><span className="material-icons text-secondary text-lg">phone</span> 09037551127</p>
                <p className="flex items-center gap-3 break-all"><span className="material-icons text-secondary text-lg">email</span> sqconsultinginc@gmail.com</p>
              </div>
          ...
          <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-purple-100/30 text-[10px] font-black uppercase tracking-[0.4em]">© 2025 SQ Consulting Group. All Rights Reserved.</p>
            <div className="flex gap-10 text-purple-100/30 text-[10px] font-black uppercase tracking-[0.4em]">
